    ...
    return (
        <div className="w-full max-w-md mx-auto">
            <div className="text-center mb-8">
                ...
                <p className="text-slate-500">Access your logistics dashboard</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex justify-end">
                        <button type="button" className="text-xs font-semibold text-orange-600 hover:text-orange-500 hover:underline transition">
                            Forgot Password?
                        </button>
                    </div>
                </div>
            ...
            {switchToRegister && (
                <p className="text-center text-sm text-slate-500">
                    ...
                    <button onClick={switchToRegister} className="text-orange-600 hover:text-orange-500 font-bold hover:underline">
                        Create Account
                    </button>
                </p>
            )}
